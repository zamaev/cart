...
type ProductServiceMock struct {
	...
	funcGetProduct          func(ProductSku model.ProductSku) (pp1 *model.Product, err error)
	inspectFuncGetProduct   func(ProductSku model.ProductSku)
...
func (mmGetProduct *mProductServiceMockGetProduct) Expect(ProductSku model.ProductSku) *mProductServiceMockGetProduct {
	...
	mmGetProduct.defaultExpectation.params = &ProductServiceMockGetProductParams{ProductSku}
...
// ExpectProductSkuParam1 sets up expected param ProductSku for productService.GetProduct
func (mmGetProduct *mProductServiceMockGetProduct) ExpectProductSkuParam1(ProductSku model.ProductSku) *mProductServiceMockGetProduct {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductServiceMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductServiceMockGetProduct) Inspect(f func(ProductSku model.ProductSku)) *mProductServiceMockGetProduct {
...
func (mmGetProduct *mProductServiceMockGetProduct) Set(f func(ProductSku model.ProductSku) (pp1 *model.Product, err error)) *ProductServiceMock {
	if mmGetProduct.defaultExpectation != nil {
...
// Then helper
func (mmGetProduct *mProductServiceMockGetProduct) When(ProductSku model.ProductSku) *ProductServiceMockGetProductExpectation {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductServiceMock.GetProduct mock is already set by Set")
	}
	...
	expectation := &ProductServiceMockGetProductExpectation{
		...
		params: &ProductServiceMockGetProductParams{ProductSku},
	}
...
func (mmGetProduct *ProductServiceMock) GetProduct(ProductSku model.ProductSku) (pp1 *model.Product, err error) {
	...
	if mmGetProduct.inspectFuncGetProduct != nil {
		mmGetProduct.inspectFuncGetProduct(ProductSku)
	}

	mm_params := ProductServiceMockGetProductParams{ProductSku}
	...
	if mmGetProduct.GetProductMock.defaultExpectation != nil {
		...
		mm_got := ProductServiceMockGetProductParams{ProductSku}
	...
	if mmGetProduct.funcGetProduct != nil {
		return mmGetProduct.funcGetProduct(ProductSku)
	}
	mmGetProduct.t.Fatalf("Unexpected call to ProductServiceMock.GetProduct. %v", ProductSku)
	return
}
