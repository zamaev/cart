...
func (mmCreate *mOrderRepositoryMockCreate) Return(o2 model.OrderID, err error) *OrderRepositoryMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("OrderRepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &OrderRepositoryMockCreateResults{o2, err}
	return mmCreate.mock
}

// Set uses given function f to mock the orderRepository.Create method
func (mmCreate *mOrderRepositoryMockCreate) Set(f func(ctx context.Context, o1 model.Order) (o2 model.OrderID, err error)) *OrderRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
func (e *OrderRepositoryMockCreateExpectation) Then(o2 model.OrderID, err error) *OrderRepositoryMock {
	e.results = &OrderRepositoryMockCreateResults{o2, err}
	return e.mock
}
...
func (mmCreate *OrderRepositoryMock) Create(ctx context.Context, o1 model.Order) (o2 model.OrderID, err error) {
